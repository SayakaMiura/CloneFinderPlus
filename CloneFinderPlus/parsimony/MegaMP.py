...
class MegaMP(object):
    ...
    def do_mega_mp_fromTree(self, alignment_builder, mega_id,treeLs):  
        self._newick_trees = treeLs#[]       
    ...
    def do_mega_mp(self, alignment_builder, mega_id):  
        ...
        if os.path.isfile(self._newick_file) == True:
          ...
          #  self.best_align_result = seq_maker.get_best_alignment(files, self._mega_id, True, self.newick_trees) 			
            self.best_align_result = seq_maker.get_all_alignment(files, self._mega_id, True, self.newick_trees) 				
        self._cleanup_temp_files()			
        return result
